      ...
      <footer className="footer-area p-5">
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-3 col-md-6 single-footer-widget">
              <h4 className=" text-14">Hỗ trợ khách hàng
              </h4>
              <ul className="text-14 !">
              <li><a className=" " href="#">Điều khoản chung</a></li>
              <li><a  className=" "  href="#">Chính sách thành viên</a></li>
              <li><a className=" "   href="#">Chính sách bảo mật</a></li>
              </ul>
            </div>

            <div className="col-lg-6 col-md-6 single-footer-widget">
              <p className="footer-text m-0 col-lg-8 col-md-12 text-14 ">{}
